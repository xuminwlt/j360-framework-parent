...
public class DefaultErrorCode extends BaseErrorCode {
    ...
    public static final BaseErrorCode AUTH_ACCESS_ROLE_ERROR = new DefaultErrorCode(401,"会话无访问权限异常");
    public static final BaseErrorCode AUTH_ACCESS_SESSION_ERROR = new DefaultErrorCode(403,"会话验证异常");
